      ...
      <aside className="w-72 bg-white border-r border-slate-100 hidden md:flex flex-col sticky top-0 h-screen">
        ...
        <nav className="flex-1 p-6 space-y-2 mt-4">
          ...
          <div className="pt-8 space-y-2">
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4 ml-2">System</p>
            <button className="flex items-center gap-3 w-full p-4 rounded-2xl text-slate-500 hover:bg-slate-50 hover:text-slate-900 transition-all font-bold group text-left">
              <Users size={20} className="text-slate-400 group-hover:text-slate-900" /> User Roles
            </button>
            <button className="flex items-center gap-3 w-full p-4 rounded-2xl text-slate-500 hover:bg-slate-50 hover:text-slate-900 transition-all font-bold group text-left">
              <Settings size={20} className="text-slate-400 group-hover:text-slate-900" /> Settings
            </button>
          </div>
        </nav>
        ...
        <div className="p-6 border-t border-slate-50">
          <button 
            ...
            className="flex items-center gap-3 w-full p-4 rounded-2xl text-red-500 bg-red-50 border border-red-100 hover:bg-red-500 hover:text-white transition-all font-bold"
          >
