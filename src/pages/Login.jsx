      ...
      <div className="w-full max-w-[480px] animate-fade">
        <div className="bg-white border border-border rounded-[32px] p-10 md:p-12 shadow-premium space-y-10">
          <div className="space-y-4 text-center">
            ...
            <p className="text-text-muted text-lg">Enter your details to access your kitchen.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            ...
            <div className="space-y-3">
              <label className="text-sm font-bold text-text-main ml-1 uppercase tracking-wider">Email Address</label>
            ...
            <button type="submit" className="w-full btn btn-primary btn-pill h-16 text-lg shadow-lg">
              <LogIn size={22} /> Continue to Recipes
            </button>
          </form>
          ...
          <div className="text-center pt-4">
            <p className="text-text-muted font-medium">
              New here?{' '}
              <Link to="/register" className="text-primary font-extrabold hover:underline">Create an account</Link>
            </p>
          </div>
        </div>
      </div>
